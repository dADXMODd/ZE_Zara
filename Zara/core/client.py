                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @UI_XB\
                                  \n\n--------بـدء تتبـع سجـل زد إي 𝒁𝑬--------\
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار زد إي 𝒁𝑬 ✘**\n\n "
                        link = "[𐇮 MODYـه 𐇮](https://t.me/UP_UO)"
